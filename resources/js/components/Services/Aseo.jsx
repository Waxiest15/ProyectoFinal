    ...
    return (
        <Container className="m-5 p-3">
            <Card className="p-3 w-75 mx-auto">
                ...
                <Form>
                    <Form.Group>
                        <Form.Label>Choose your pet</Form.Label>
                    ...
                    <Form.Group className="mb-3" controlId="fechaHoy">
                        <Form.Label>Take a date</Form.Label>
                        <Form.Control
                            type="date"
                            onSelect={getToday}
                            required
                ...
                <Carousel className="bg-light w-100 mx-auto">
                    ...
                    >
                        <img
                            ...
                            alt="Second slide"
                        />
                        <Carousel.Caption className="text-dark bg-light w-25 h-25 mx-auto">
                            Search near options
                        </Carousel.Caption>
                    </Carousel.Item>
                </Carousel>
